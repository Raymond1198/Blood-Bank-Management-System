    ...
    <div class="col-lg-4 mb-4">
        ...
        <p>
           <h4>Address :</h4> <?php echo $row['contact_address']; ?>
            <!--<h4>Address :</h4> Federal University of Technology Minna <br> PMB 65-->
        </p>
        <p>
            <h4>Contact Number :</h4><?php echo $row['contact_phone']; ?>
            <!--<h4>Contact Number :</h4> +234 0817 985 2834--> <?//php echo $row['contact_phone']; ?>
        </p>
        <p>
          <h4>  Email: </h4><a href="#"> <?php echo $row['contact_mail']; ?></a>
          <!--<h4>  Email: </h4><a href="#">raymondogbiko@gmail.com</a>-->
          </a></b>
        </p>
        <?php }
      } ?>
